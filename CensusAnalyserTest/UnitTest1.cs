...
namespace CensusAnalyserTest
{
    public class Tests
    {
        ...
        static string indianStateCensusFilePath = @"C:\Users\NITISH KUMAR\source\repos\i\CensusAnalyserTest\CSVFiles\IndiaStateCensusData.csv";
        static string wrongHeaderIndianCensusFilePath = @"C:\Users\NITISH KUMAR\source\repos\i\CensusAnalyserTest\CSVFiles\WrongIndiaStateCensusData.csv";
        static string delimiterIndianCensusFilePath = @"C:\Users\NITISH KUMAR\source\repos\i\CensusAnalyserTest\CSVFiles\DelimiterIndiaStateCensusData.csv";
        static string wrongIndianStateCensusFilePath = @"C:\Users\NITISH KUMAR\source\repos\i\CensualAnalyserTest\CsvFiles\WrongIndiaStateCensusData.csv";
        static string wrongIndianStateCensusFileType = @"C:\Users\NITISH KUMAR\source\repos\i\CensualAnalyserTest\CsvFiles\WrongIndiaStateCensusData.txt";
        static string indianStateCodeFilePath = @"C:\Users\NITISH KUMAR\source\repos\i\CensusAnalyserTest\CSVFiles\IndiaStateCode.csv";
        static string wrongIndianStateCodeFileType = @"C:\Users\NITISH KUMAR\source\repos\i\CensusAnalyserTest\CSVFiles\WrongIndiaStateCode.txt";
        static string delimiterIndianStateCodeFilePath = @"C:\Users\NITISH KUMAR\source\repos\i\CensusAnalyserTest\CSVFiles\DelimiterIndiaStateCode.csv";
        static string wrongHeaderStateCodeFilePath = @"C:\Users\NITISH KUMAR\source\repos\i\CensusAnalyserTest\CSVFiles\WrongIndiaStateCode.csv";
